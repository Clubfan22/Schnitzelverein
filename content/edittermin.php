...
<form class="form-horizontal" method="post" target="index.php?page=edittermin"<?php if (isset($id)) {
	echo "&id=" . $id;
} ?>>
	<div class="row">
		<div class="col-lg-12">
			<div class="termin">
				...
				<div class="termin-body col-md-8 col-sm-12">
					<textarea id="textInput" name="textInput" placeholder="Beschreibungstext mit Tagesordnung"<?php if (isset($event["city"])) {
							echo " value=\"" . $event["text"] . "\"";
						} ?>></textarea>
				</div>
